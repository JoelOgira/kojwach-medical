                ...
                <div className="bg-white bg-opacity-70">
                    <div className="px-5 py-8 md:px-0 md:container md:mx-auto md:w-5/6 lg:w-3/4">
                        <div className="flex space-x-5 mb-3">
                            ...
                            <h1 className="text-[#b12828] font-bold font-poppins text-4xl">Contact Us</h1>
                        </div>
                ...
                <div className="flex flex-col space-y-5">
                    <div className="flex flex-col w-full md:flex-row md:space-y-0 md:space-x-20">
                        <div className="w-full grid content-center text-start justify-start px-5 md:px-0 md:w-1/3 md:justify-start md:items-start md:text-left">
                            <h2 className="pb-8 text-tertiary text-2xl pt-8 font-semibold font-poppins underline">Contact Us</h2>

                            <div className="w-full flex flex-row space-x-5 border-b pb-8 text-left">
                                <VscLocation className="text-4xl text-tertiary" />
                                <div>
                                    <h4 className="font-semibold font-poppins pb-3 text-2xl text-tertiary">Address</h4>
                            ...
                            <div className="w-full flex flex-row space-x-5 border-b py-8 text-left">
                                ...
                                <div>
                                    <h4 className="font-semibold font-poppins pb-3 text-2xl text-tertiary">Call Us</h4>
                            ...
                            <div className="w-full flex flex-row space-x-5 border-b py-8 text-left">
                                ...
                                <div>
                                    <h4 className="font-semibold font-poppins pb-3 text-2xl text-tertiary">Email Address</h4>
                            ...
                            <div className="w-full flex flex-row space-x-5 border-b py-8 text-left">
                                ...
                                <div>
                                    <h4 className="font-semibold font-poppins pb-3 text-2xl text-tertiary">Visiting Hours</h4>
                        ...
                        <div className="w-full shadow-md md:w-2/3 md:my-0">
                            <div className="px-5">
                                ...
                                <p className="text-tertiary font-bold font-poppins text-3xl">Visit Us</p>
                            </div>
