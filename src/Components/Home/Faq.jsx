    ...
    return (
        <section className="faq-bg w-full">
            ...
            <div className="faq-quiz">
                <div className="px-5 py-20 md:px-0 md:container md:mx-auto md:w-5/6 lg:w-3/4">
                    <div className="flex flex-col space-y-16 md:flex-row md:space-y-0 md:space-x-12">
